...
class OrderController extends Controller
{
    ...
    public function editOrder($iv_id)
    {
        ...
        $manager_order = view('admin.orders.edit-order')->with('edit_order', $edit_order);
        return view('admin.layout')->with('admin.orders.edit-order', @$manager_order);
    }
    public function updateOrder(Request $request, $iv_id)
    {
        ...
        return Redirect::to("admin/orders/edit/$iv_id");
    }
