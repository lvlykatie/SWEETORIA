...
class ProductTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
       ...
       $products = [
        ['name' => 'All-purpose Flour', 'image' => 'https://i.imgur.com/w7bQ2Z3.png', 'price' => 100000, 'category' => 'Baking ingredients'],
        ...
        ['name' => 'Cocoa Powder', 'image' => 'https://i.imgur.com/fGyULED.jpeg', 'price' => 140000, 'category' => 'Baking ingredients'],
