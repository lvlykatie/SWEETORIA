        ...
        <div class="products flex flex-col items-center w-full gap-y-10">
            ...
            @foreach ($wishlistItems as $wishlistItem)
                <div class="flex items-center rounded-xl shadow-lg relative bg-product w-full md:w-2/3 h-44 md:h-[200px]"
                    ...
                    <!-- Product Image -->
                    <img src="{{ filter_var($wishlistItem->product->product_image, FILTER_VALIDATE_URL) ? $wishlistItem->product->product_image : asset('public/backend/image/' . $wishlistItem->product->product_image) }}"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            removeButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    '[data-product-id]'); // Tìm phần tử cha chứa sản phẩm
