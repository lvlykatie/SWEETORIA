...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/public/frontend/Admin/CSS/style.css">
<link rel="stylesheet" href="/public/frontend/Admin/CSS/satoshi.css">
                ...
                <div>
                  ...
                  >
                    <div class="relative h-14 w-14 rounded-full">
                      <img src="./image/user/user-03.png" alt="User" />
                      <span
                  ...
                  >
                    <div class="relative h-14 w-14 rounded-full">
                      <img src="./image/user/user-04.png" alt="User" />
                      <span
                        class="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-3"
                      ></span>
                    </div>
                  ...
                  >
                    <div class="relative h-14 w-14 rounded-full">
                      <img src="./image/user/user-05.png" alt="User" />
                      <span
                  ...
                  >
                    <div class="relative h-14 w-14 rounded-full">
                      <img src="./image/user/user-01.png" alt="User" />
                      <span
                        class="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-3"
                      ></span>
                    </div>
                  ...
                  >
                    <div class="relative h-14 w-14 rounded-full">
                      <img src="./image/user/user-02.png" alt="User" />
                      <span
  ...
  <script src="/public/frontend/Admin/js/index.js"></script>
</html>
