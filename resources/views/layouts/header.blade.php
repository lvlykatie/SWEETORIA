<header class="flex justify-around">
    ...
    <nav class="px-40 flex">
        <ul class="flex justify-between items-center h-full">
            <li
                class="nav-item text-2xl font-black relative group hover:bg-slate-400 transition duration-300 ease-in-out">
                <a href="{{ route('homepage') }}"
                    class="block h-full w-full p-4 transition duration-300 ease-in-out transform group-hover:scale-110">
                    Home
                </a>
            </li>
            <li
    ...
    <div class="flex items-center gap-4">
        <a href="{{ route('cart') }}">
            <svg class=" nav-item" width="48" height="50" viewBox="0 0 48 50" fill="none"
        ...
        <a href="{{ route('account') }}">
            <svg class="nav-item" width="48" height="50" viewBox="0 0 50 52" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
