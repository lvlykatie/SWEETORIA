...
@section('content')
    <div class="hot-deal">
        <div class="search-bg relative flex items-center justify-center"
            style="background-image: url('{{ asset('frontend/client/page/image/hotdeal.png') }}');
    background-size: cover; background-position: center; height: 450px;">
        ...
        <div class="px-40">
            ...
            <div class="row gap-x-96 flex justify-around py-6">
                ...
                <div class="col-md-4">
                    <img src="{{ asset('frontend/client/page/image/Deal_1.png') }}" alt="Mid Autumn Festive Sale"
                        class="img-fluid">
