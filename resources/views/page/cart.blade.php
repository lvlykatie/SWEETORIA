        ...
        <div class="products flex flex-col items-center w-full gap-y-10">
            ...
            @foreach ($products as $product)
                ...
                data-product-id="{{ $product['id'] }}">
                    ...
                    <div class="flex-grow">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex items-center rounded-md py-10">
                                <!-- Nút giảm số lượng -->
                            <button class="decrease-quantity px-2 py-1 bg-gray-100 hover:bg-gray-200"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <!-- Nút tăng số lượng -->
                                <button class="increase-quantity px-2 py-1 bg-gray-100 hover:bg-gray-200"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="22" height="22" viewBox="0 0 22 22" fill="none">
                                    <path
                    ...
                    <!-- Product Price -->
                    <div class="product-total-price text-red-800 text-5xl font-light font-['Inter'] md:text-5xl absolute right-2 bottom-0">
