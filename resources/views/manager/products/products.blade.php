            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="flex justify-between">
                    ...
                    <form class="max-w-md" style="width: 500px;" action="{{ route('products.search') }}" method="GET">
                        ...
                        <div class="relative">
                            <input type="text" name="query" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search products" />
                ...
                <div class="w-full mt-6">
                    <p class="text-xl pb-3 flex items-center justify-between">
                        ...
                        <button class="bg-blue-500 text-white py-1 px-4 rounded ml-auto">
                            ...
                            <a href="{{URL::to('manager/products/create')}}">Product</a>
                        </button>
                    </p>
                            ...
                            <tbody class="text-gray-700" id="productTable">
                                <tr>
                                    ...
                                    <td class="text-center py-3 px-1">
                                        <button onclick="window.location.href='{{URL::to('/manager/products/edit/' . $product->product_id)}}'" class="bg-green-500 text-white py-1 px-4 rounded hover:bg-green-600">
                                            <i class="fa-solid fa-pen"></i>
                                        </button>
                                        <button onclick="if(confirm('Are you sure you want to delete this product?')) { window.location.href='{{URL::to('/manager/products/delete/' . $product->product_id)}}' }" class="bg-red-500 text-white py-1 px-4 rounded hover:bg-red-600">
