        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <div class="flex justify-between">
                    ...
                    <!-- Search form -->
                    <form class="max-w-md" style="width: 500px;" action="{{ route('manager.orders.search') }}" method="GET">
                            ...
                            <tbody class="text-gray-700" id="orderTable">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center py-3 px-4">
                                        <button onclick="window.location.href='{{URL::to('/manager/orders/edit/' . $order->iv_id)}}'" class="bg-green-500 text-white py-1 px-4 rounded hover:bg-green-600">
                                            <i class="fa-solid fa-pen"></i>
                                        </button>
                                        <button onclick="if(confirm('Are you sure you want to delete this order?')) { window.location.href='{{URL::to('/manager/orders/delete/' . $order->iv_id)}}' }" class="bg-red-500 text-white py-1 px-4 rounded hover:bg-red-600">
